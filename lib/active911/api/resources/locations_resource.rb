    ...
    class LocationsResource < Resource
      def show(location_id:)
        ...
        begin
          ...
          raise Error, "Non JSON response received from Active911 (locations/#{location_id}) API: URL: #{result.env.url}, body: #{result.body}"
        end
      ...
      def index
        ...
        begin
          ...
          raise Error, "Non JSON response received from Active911 (locations) API: URL: #{result.env.url}, body: #{result.body}"
        end
