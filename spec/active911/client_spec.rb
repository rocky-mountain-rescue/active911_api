...
RSpec.describe Active911::API::Client do
  ...
  it "loads api_refresh_key" do
    expect(Active911::API::Client.new(api_refresh_key: "bar").api_refresh_key).to eql "bar"
  end
  ...
  it "obtains an api_key from api_refresh" do
    ...
    client = Active911::API::Client.new(api_refresh_key: "bar")
    client.get_access_token
    expect(client.api_key).to eql "baz"
    expect(client.api_key_expiration).to eql 123
  end
end
